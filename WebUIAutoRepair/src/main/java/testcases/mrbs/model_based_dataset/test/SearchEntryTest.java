...
public class SearchEntryTest {
	...
	public static void searchEntryTest() throws Exception {
		...
		driver.findElement(By.xpath("/html/body/form/input[1]")).sendKeys("Demo Entry");
		driver.findElement(By.xpath("//input[@value='Search']")).click();
		Thread.sleep(2000);
		//try {
			Assert.assertEquals(driver.findElement(By.xpath("//td[text()='Demo Entry']")).getText(), "Demo Entry");
//		} catch (Exception e) {
//			e.printStackTrace();
//		}
	}
