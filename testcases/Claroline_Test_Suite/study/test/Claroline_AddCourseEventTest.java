...
import testcases.Claroline_Test_Suite.study.po.CalendarAgendaPage;
...
public class Claroline_AddCourseEventTest {
	...
	public void runTest() throws InterruptedException{
		...
		//DesktopPage dp = ip.login("admin", "admin");
		...
		CalendarAgendaPage cap = cip.goToCalendarAgendaPage();
		cap.addEvent("Exam 001", "31", "May", "2023", "Genoa");//2013->2023
		assertEquals("Event added to the agenda.", cap.getMessage());
		cap.doLogout();
	}
}
