...
public class Claroline_SearchAndRemovePasswordCourseTest {
	...
	public void runTest() throws InterruptedException{
		...
		AdvancedCourseSearchPage ausp = ap.advancedCourseSearch();
		AdminCoursesPage acp = ausp.searchPassword("Course002");
