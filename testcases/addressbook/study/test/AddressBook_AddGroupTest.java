...
public class AddressBook_AddGroupTest {
	...
	public void runTest() throws InterruptedException{
		...
		gp.addNewGroup("Group", "Header", "Footer");
		assertTrue(gp.getMsg().contains("A new group has been entered into the address book."));		
	}
}
