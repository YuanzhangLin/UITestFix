...
public class AddressBook_PrintMultipleAddressBookTest {
	...
	public void runTest() throws InterruptedException{
		...
		assertTrue(vp.getAddressBookContent(1).contains("address1"));
		assertTrue(vp.getAddressBookContent(1).contains("01056321"));
		assertTrue(vp.getAddressBookContent(1).contains("mail1@mail.it"));
		...
		assertTrue(vp.getAddressBookContent(2).contains("address2"));
		assertTrue(vp.getAddressBookContent(2).contains("01056322"));
		assertTrue(vp.getAddressBookContent(2).contains("mail2@mail.it"));
		...
		assertTrue(vp.getAddressBookContent(3).contains("address3"));
		assertTrue(vp.getAddressBookContent(3).contains("01056323"));
		assertTrue(vp.getAddressBookContent(3).contains("mail3@mail.it"));
