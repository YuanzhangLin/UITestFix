...
public class Collabtive_EditProjectTest {
public WebDriver driver;
	...
	public void runTest() throws InterruptedException{
		...
		ManageProjectPage mpp = ap.editProject();
		mpp.editProjectDate("20.03.2023");
		mpp.openEditProjectFrame();
		assertEquals("20.03.2023", mpp.getProjectDate());
		mpp.doLogout();		
	}
}
