...
public class Collabtive_EditRoleTest {
	...
	public void runTest() throws InterruptedException{
		...
		ap.getRoleDetails();
		ap.editRole("NewRole");
		assertEquals("NewRole", ap.getFirstNewRoleAddedName());
		ap.getRoleDetails();
		assertFalse(ap.isNewRoleAddedEditPermissionChecked());
		assertFalse(ap.isNewRoleAddedClosePermissionChecked());
		ap.doLogout();		
	}
}
