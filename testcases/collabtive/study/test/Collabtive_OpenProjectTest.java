...
public class Collabtive_OpenProjectTest {
	...
	public void runTest() throws InterruptedException{
		...
		ManageProjectPage mpp = ap.openProject();
		ap = mpp.goToAdminPage();
		assertEquals("Project001", ap.getOpenProjectName());
		assertEquals("Close", ap.getReverseOpenProjectTitle());
		ap.doLogout();
	}
}
