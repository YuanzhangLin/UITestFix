...
public class Collabtive_RemoveTaskDesktopNotPresentTest {
	...
	public void runTest() throws InterruptedException{
		...
		Alert alert = mtp.removeTask();
		Thread.sleep(2000);
		alert.accept();
		ip = mtp.goToIndexPage();
		assertTrue(!ip.getBodyText(driver).contains("desktopTask"));
		ip.doLogout();
	}
}
