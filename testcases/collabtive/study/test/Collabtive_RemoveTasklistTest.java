...
public class Collabtive_RemoveTasklistTest {
	...
	public void runTest() throws InterruptedException{
		...
		Alert alert = mtp.deleteTaskList();
		Thread.sleep(2000);
		alert.accept();
		Thread.sleep(3000);
		assertTrue(mtp.getBodyText(driver).contains("No tasklist found. Please create a tasklist."));
		mtp.doLogout();
	}
}
