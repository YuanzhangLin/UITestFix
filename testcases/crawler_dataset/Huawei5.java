...
public class Huawei5 {
    ...
    public static void test() throws Exception {
        driver.findElement(By.xpath("/html/body/footer/div[1]/div[2]/div[1]/div/ul[2]/li[5]/a")).click();//Bond Investors
        String url = (String) ((JavascriptExecutor)driver).executeScript("var url;url =window.location.href;return url");

        try {
            AssertJUnit.assertTrue(url.toLowerCase(Locale.ROOT).contains("invest"));
