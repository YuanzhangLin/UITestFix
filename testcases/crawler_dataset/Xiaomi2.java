...
public class Xiaomi2 {
    ...
    public static void test() throws Exception {
        driver.findElement(By.xpath("/html/body/div[8]/div[2]/div[1]/div/div/dl[2]/dd[3]/a")).click();//user agreement
        String url = (String) ((JavascriptExecutor)driver).executeScript("var url;url =window.location.href;return url");

        try {
            AssertJUnit.assertTrue(url.toLowerCase(Locale.ROOT).contains("agreement"));
