...
public class UpdateCategoryTest {
	...
	public void doTest(){
		...
		ManageProjectCategoryEditPage mpcep = mpep.editCategory();
		ManageProjectCategoryUpdatePage mpcup = mpcep.editCategoryName("Category002");
		mpep = mpcup.proceed();
		assertEquals("Category002", mpep.getCategoryName());
		mpep.doLogout();
	}
}
