...
public class Entry {
    ...
    public static void addEntryBySql(int room_id, String name, String description) throws SQLException, IOException, ClassNotFoundException {
        clear();
        SQL_Process sql_process = new SQL_Process();
        sql_process.addEntry(room_id,name,description);
        sql_process.sqlClose();
    }
