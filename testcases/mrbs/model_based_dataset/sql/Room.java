...
public class Room {
    ...
    public static void addRoom(String name, String cap, String area_id,int room_id) throws SQLException, IOException, ClassNotFoundException {
        SQL_Process sql_process = new SQL_Process();
        if (sql_process.containRoom(name)) {
            sql_process.deleteRoom(name);
        }
        sql_process.addRoom(name, cap, area_id,room_id);
        sql_process.sqlClose();
    }
