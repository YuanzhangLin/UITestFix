...
public class MRBS_AddMultipleEntriesSameRoomSameDayTest {
	...
	public void runTest() throws InterruptedException{
		...
		//12 aprile 2023, 3 eventi
		dp = eep.addEntry("MyEvent1", "Description for MyEvent1", "12", 3, "2023", "1", "8", "", "MyBuilding", "MyRoom");
		eep = dp.addEntry(25,1);
		dp = eep.addEntry("MyEvent2", "Description for MyEvent2", "12", 3, "2023", "3", "11", "", "MyBuilding", "MyRoom");
		eep = dp.addEntry(25,1);
		dp = eep.addEntry("MyEvent3", "Description for MyEvent3", "12", 3, "2023", "2", "15", "", "MyBuilding", "MyRoom");
